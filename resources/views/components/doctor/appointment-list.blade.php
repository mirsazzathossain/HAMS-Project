<x-admin-layout>
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto">
            <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"> Appointment </h2>

            <h4 class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300"> All Appointments </h4>
            @if (session('success'))
